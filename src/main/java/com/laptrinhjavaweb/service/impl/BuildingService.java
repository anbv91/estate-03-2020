...
public class BuildingService implements IBuildingService{
	...
	@Override
	public Optional<BuildingDTO> findById() {
		BuildingDTO buildingDTO = new BuildingDTO();

		Optional<BuildingDTO> results= Optional.ofNullable(buildingDTO);
		Optional<BuildingEntity> buildingEntites= buildingRepository.findById();
